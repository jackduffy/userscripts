            ...
            if (messages) {
                ...
                for (let i = 0; i < messages.length; i++) {
                    ...
                    if (!messages[i].classList.contains('bc-tag-visited')) {
                        ...
                        const tags = (messages[i].innerHTML).match(/(^|\W)(#[a-z\d][\w-]*)/ig);
                ...
                if (original_tags.length) {
                    ...
                    sidebar_container.innerHTML = '<div id="bc-tag-sidebar">' + laserred_logo + '<ul>' + sidebar_html + '</ul></div>';
